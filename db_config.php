 ...
 *
 *   MASSOPEN_DB_HOST=localhost
 *   MASSOPEN_DB_NAME=massopen
 *   MASSOPEN_DB_USER=massopen
 *   MASSOPEN_DB_PASS=super-secret
 *   MASSOPEN_DB_PORT=3306        (optional, defaults to 3306)
 */

return [
    'host'    => getenv('MASSOPEN_DB_HOST') ?: 'localhost',
    'name'    => getenv('MASSOPEN_DB_NAME') ?: 'massopen',
    'user'    => getenv('MASSOPEN_DB_USER') ?: 'massopen',
